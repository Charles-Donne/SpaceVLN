...
**Role**: Spatial reasoning + navigation planning. Locate current position, choose next move, and output precise navigation instructions. NOT manipulation (doors/objects). End at the final waypoint.

**Task**: {instruction}

**Initial state note**: This is initial planning (no waypoint/history yet). First complete stage #1 by moving to the nearest relevant landmark.
...
# Map Legend
**Colors**: White=unexplored | Black=obstacles | Green=safe floor | Orange=trajectory | Red arrow=you | Red dash=Forward
...
**Role**: Spatial reasoning and navigation planning. Use waypoint history and maps to determine where you are, decide where to go next, and issue precise navigation instructions. NOT manipulation (doors/objects). End at the final waypoint.
