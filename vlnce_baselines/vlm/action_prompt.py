...
4. **Arrival Check**: Check whether the current subtask destination is already reached in the current detection view. Confirm the room first, then confirm the displayed destination landmark/object is already within about 0.5m. If yes, **STOP immediately**.
...
**Ex3 - At destination**
{{
    "reasoning": "The current subtask destination is already reached: the current room matches the target room, and the displayed destination landmark is already within about 0.5m. STOP immediately.",
...
- **STOP immediately** only when the correct room/space is confirmed and the displayed destination landmark/object is already within about 0.5m
