...
{{
    "reasoning": "The target cue is already very near, waypoint history stays aligned, and front is still safe. Keep the action minimal; the system will auto-end the current subtask once one of the highest-confidence top-2 displayed destination landmarks enters about 0.5m.",
