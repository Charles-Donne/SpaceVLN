...
Runtime-switchable experiment config stays in `vlnce_baselines/config/runtime/default.py`.
Project-level static parameters are grouped under `vlnce_baselines/config/core/params/`.
...
from vlnce_baselines.config.core.params.rendering import (
    COLOR_PALETTE,
    DETECTION_COLORS,
    DETECTION_THICKNESS,
...
from vlnce_baselines.config.core.params.semantic import (
