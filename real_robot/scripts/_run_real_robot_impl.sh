...
export SPACEVLN_CONTINUOUS_TURN_TARGETS="${SPACEVLN_CONTINUOUS_TURN_TARGETS:-1}"
export SPACEVLN_ALLOW_ALTERNATING_TURNS="${SPACEVLN_ALLOW_ALTERNATING_TURNS:-1}"
export SPACEVLN_DISABLE_CORRIDOR_AUTOSTOP="${SPACEVLN_DISABLE_CORRIDOR_AUTOSTOP:-1}"
export SPACEVLN_SPACE_AREA_REGION_RADIUS_M="${SPACEVLN_SPACE_AREA_REGION_RADIUS_M:-3.0}"
export SPACEVLN_SPACE_AREA_MAX_CONNECTION_DISTANCE_M="${SPACEVLN_SPACE_AREA_MAX_CONNECTION_DISTANCE_M:-4.0}"
export SPACEVLN_SPACE_AREA_MAX_SAME_TYPE_WAYPOINT_MERGE_DISTANCE_M="${SPACEVLN_SPACE_AREA_MAX_SAME_TYPE_WAYPOINT_MERGE_DISTANCE_M:-4.0}"
export SPACEVLN_STRICT_PLANNER_FINISH_GUARD="${SPACEVLN_STRICT_PLANNER_FINISH_GUARD:-1}"
export SPACEVLN_PLANNER_FINISH_NEAR_M="${SPACEVLN_PLANNER_FINISH_NEAR_M:-1.0}"
export SPACEVLN_REAL_SAVE_ACTION_MAPS="${SPACEVLN_REAL_SAVE_ACTION_MAPS:-1}"
export SPACEVLN_REAL_PRINT_MAP_UPDATE="${SPACEVLN_REAL_PRINT_MAP_UPDATE:-1}"
...
echo "[RealRobot] space_area_region_radius_m=${SPACEVLN_SPACE_AREA_REGION_RADIUS_M}"
echo "[RealRobot] space_area_connection_m=${SPACEVLN_SPACE_AREA_MAX_CONNECTION_DISTANCE_M} same_type_merge_m=${SPACEVLN_SPACE_AREA_MAX_SAME_TYPE_WAYPOINT_MERGE_DISTANCE_M}"
echo "[RealRobot] strict_planner_finish_guard=${SPACEVLN_STRICT_PLANNER_FINISH_GUARD} planner_finish_near_m=${SPACEVLN_PLANNER_FINISH_NEAR_M}"
echo "[RealRobot] save_action_maps=${SPACEVLN_REAL_SAVE_ACTION_MAPS}"
echo "[RealRobot] print_map_update=${SPACEVLN_REAL_PRINT_MAP_UPDATE}"
