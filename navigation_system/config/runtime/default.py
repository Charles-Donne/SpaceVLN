...
def _build_control_defaults() -> CN:
    ...
    cfg.GEOMETRIC_WAYPOINT = CN()
    cfg.GEOMETRIC_WAYPOINT.ENABLE = False
    cfg.GEOMETRIC_WAYPOINT.MAX_CANDIDATES = 5
    cfg.GEOMETRIC_WAYPOINT.MIN_DISTANCE_M = 0.8
    cfg.GEOMETRIC_WAYPOINT.MAX_DISTANCE_M = 4.0
    cfg.GEOMETRIC_WAYPOINT.STRIDE_M = 0.75
    cfg.GEOMETRIC_WAYPOINT.OBSTACLE_INFLATION_RADIUS_M = 0.30
    cfg.GEOMETRIC_WAYPOINT.UNKNOWN_AS_OBSTACLE = True
    cfg.GEOMETRIC_WAYPOINT.MIN_CLEARANCE_M = 0.20
    cfg.GEOMETRIC_WAYPOINT.PATH_STEP_M = 0.35
    cfg.GEOMETRIC_WAYPOINT.ARRIVAL_RADIUS_M = 0.35
    cfg.GEOMETRIC_WAYPOINT.MAX_PATH_EXECUTE_STEPS = 12
    cfg.GEOMETRIC_WAYPOINT.STOP_ON_BLOCKED_FRONT = True
    return cfg
