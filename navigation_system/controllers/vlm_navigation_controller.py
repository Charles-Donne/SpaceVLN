...
from navigation_system.utils.spatial_formatter import (
    build_action_landmark_map_info,
    build_waypoint_summary,
)
from navigation_system.controllers.base_navigation_controller import BaseNavigationController
from navigation_system.controllers.runtime_state import (
    EpisodeTimingTracker,
    VLMControllerOptions,
)
from navigation_system.mapping.space_types import (
...
from navigation_system.vlm.support.navigation_visualizer import NavigationVisualizer
from navigation_system.vlm.support.thinking_view_renderer import ThinkingViewRenderer
...
class VLMNavigationController(BaseNavigationController):
    ...
    def __init__(self, config: Config,
                 config_path: str = "navigation_system/config/api/vlm_api_config.yaml"):
        """
        初始化VLM导航控制器
...
# print("\n[Init] 初始化VLM模块...")
        ...
        self.runtime_options = VLMControllerOptions.from_map_config(
            config.MAP,
    ...
    def reset_episode(self, episode_id: int = None):
        ...
        self.save_manager = SaveManager(
            ...
            save_best_result_copy=self.runtime_options.save_best_result_copy,
        )
