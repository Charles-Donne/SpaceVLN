...
{{
  "reasoning": "One concise chain: environment perception + current view, landmark/task cues, position/progress/arrival check, then the safest action toward the current-stage destination",
