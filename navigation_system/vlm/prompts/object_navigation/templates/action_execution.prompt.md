...
4. **Action Decision + Obstacle Avoidance**: choose one safe immediate action that follows the subtask and advances the search. Apply arrival first, then stage-following/direction, then forward distance and obstacle avoidance.
   **Action guidance**:
